...
public class TeraSort extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    boolean useSimplePartitioner = getUseSimplePartitioner(job);
	  LOG.info("useSimplePartitioner is " + useSimplePartitioner);
    ...
    long memoryMb = job.getConfiguration().getLong(YarnConfiguration.NM_PMEM_MB,
        YarnConfiguration.DEFAULT_NM_PMEM_MB);
    int vcores = job.getConfiguration().getInt(YarnConfiguration.NM_VCORES,
        YarnConfiguration.DEFAULT_NM_VCORES);
    LOG.info("NM memory Mb: " + memoryMb + "; NM vcores: " + vcores);
