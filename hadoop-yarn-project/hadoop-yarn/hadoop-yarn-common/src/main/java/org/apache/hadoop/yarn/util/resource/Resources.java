...
public class Resources {
  ...
  //   public ReduceSize(ApplicationAttemptId applicationAttemptId) {
  //     this.applicationAttemptId = applicationAttemptId.toString();
  ...
  //   @Override
  //   public int hashCode() {
  //     return applicationAttemptId.hashCode();
  //   }

  //   @Override
  //   public String toString() {
  //     StringBuilder sb = new StringBuilder();
  //     sb.append("application attempt id: ").append(applicationAttemptId)
