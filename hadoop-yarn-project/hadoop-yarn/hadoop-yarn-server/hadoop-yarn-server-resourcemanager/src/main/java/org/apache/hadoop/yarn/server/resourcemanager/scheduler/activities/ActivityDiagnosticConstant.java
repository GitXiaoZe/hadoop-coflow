...
public class ActivityDiagnosticConstant {
  ...
  public final static String REDUCE_NUM_SKIPPED = "Reduce num is greater than 3, skipped";
  public final static String SHUFFLE_SIZE_SKIPPED = "Shuffle size is not smallest, skipped";
}
