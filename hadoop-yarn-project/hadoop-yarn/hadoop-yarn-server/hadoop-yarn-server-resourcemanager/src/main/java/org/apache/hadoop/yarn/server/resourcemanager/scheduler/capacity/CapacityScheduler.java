...
public class CapacityScheduler extends
  ...
  public Allocation allocate(ApplicationAttemptId applicationAttemptId,
    ...
    try {
      ...
      if (!ask.isEmpty() || (schedulingRequests != null && !schedulingRequests
        ...
        // application.updateResourceRequests place ask to a map to wait NM to get
  ...
  private void allocateContainersToNode(NodeId nodeId,
    ...
    if (null != node) {
      ...
      if(assignedContainers != 0) {
        LOG.info("This is " + node + ". And the assignment's num is: " + assignedContainers + " and the assignment is: " + assignment);
        // LOG.info("What are candidates? " + candidates.getAllNodes());
      }
    }
  }
  ...
  private CSAssignment allocateOrReserveNewContainers(
    ...
    LOG.info("condition: Try to use NON_EXCLUSIVE.");
  ...
  CSAssignment allocateContainersToNode(
    ...
    if (assignment != null && assignment.getAssignmentInformation() != null
      ...
      // if(single == 1) {
      //   LOG.info("allocateContainerOnSingleNode");
      // }
      // else {
      //   LOG.info("allocateContainersOnMultiNodes");
      // }
    }
    return assignment;
  }
